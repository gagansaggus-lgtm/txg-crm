...
import { FulfillmentOrderForm } from "@/components/warehouse/fulfillment-order-form";
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        subtitle="Capture what to pick and where to ship it. Add line items on the detail page."
      />
      <Card>
        {customers.length === 0 ? (
